...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[85vh] items-center justify-center p-4">
      ...
      >
        <div className="absolute top-0 right-0 h-64 w-64 bg-gradient-to-bl from-primary/20 to-transparent blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 text-center mb-8">
          ...
          <p className="mt-2 text-sm text-text-secondary font-medium">Please enter your details to sign in.</p>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-surface px-3 text-xs font-bold uppercase tracking-widest text-text-secondary">Or continue with email</span>
            </div>
          </div>
          ...
          <div className="pt-4 text-center text-sm font-medium text-text-secondary">
            Don't have an account?{' '}
            <Link href="/signup" className="text-primary hover:text-secondary transition-colors font-bold">
              Sign up
            </Link>
          </div>
          <div className="pt-1 text-center text-xs font-semibold text-text-secondary opacity-60">
            Demo credentials: student@forge.dev / password
          </div>
        </div>
      </motion.div>
    </div>
